...
public class Customer implements Printable{
    ...
    String Status;
    int coupons;
    public static ArrayList<List> customer_cart=new ArrayList<>();
    ...
    public double getWallet() {
        return Customer.customer_list.get(Global.index).Wallet;
    }
    public void print_(){
        System.out.println("Customer successfully registered!!!");
    };
    public void setWallet(double wallet) {
        Customer.customer_list.get(Global.index).Wallet -= wallet;
    }
    ...
    public static void Login_Menu() {
        ...
        if (choice4 == 1) {
            ...
            for (int a = 0; a < Customer.customer_list.size(); a++) {
                if (Customer.customer_list.get(a).customer_name.equals(Global.temp1) && (Customer.customer_list.get(a).customer_password.equals(Global.temp2))) {
                    ind = a;
                }
                else{
                    ind++;
                ...
                if (sts.equals(Customer.customer_list.get(Global.index).Status)) {
                    ...
                    if (Customer.customer_list.get(Global.index).Status.equals("PRIME")) {
                        if (sts.equals("NORMAL")) {
                            ...
                            if (Customer.customer_list.get(Global.index).Wallet < 300) {
                                System.out.println("Insufficient Balance!!!");
                                System.out.println(" ");
                                Login_Menu();
                            } else {
                                Customer.customer_list.get(Global.index).Wallet -= 300;
                                Customer.customer_list.get(Global.index).Status = sts;
                        ...
                        if (sts.equals("ELITE")) {
                            ...
                            if (Customer.customer_list.get(Global.index).Wallet < 200) {
                                System.out.println("Insufficient Balance!!");
                                System.out.println("----------------------------------------------");
                                System.out.println(" ");
                            } else {
                                Customer.customer_list.get(Global.index).Wallet -= 200;
                                Customer.customer_list.get(Global.index).Status = sts;
                ...
                //int z = Global.index;
                Customer.customer_list.get(Global.index).Wallet += amount;
